...
('0003', 'Benedetto da Rovezzano', '1524-29', 'Angel Bearing Candlestick', 'An angel bearing a candlestick', 'Italy', 'Renaissance', 'The Tudors: Art and Majesty in Renaissance England'),
...
('0005', 'Hans Holbein the Younger', '1533-36', 'Anne Boleyn', 'Portrait of Anne Boleyn', 'England', 'Renaissance', 'The Tudors: Art and Majesty in Renaissance England'),
...
('0010', 'Isidore Leroy', '1908-09', 'Wallpaper: pattern 15292 R', 'The wallpapers and borders displayed here are similar or identical to those the Cubists used in their collages and pastiched in their paintings.', 'France', 'Modern', 'Cubism and the Trompe l''Oeil Tradition'),
...
('0013', 'Simone Leigh', '2021-22', 'Large Jug', 'Abstract mug', 'American', 'Modern', 'Hear Me Now: The Black Potters of Old Edgefield, South Carolina'),
...
('0016', 'Robert Campin', '1400-1500', 'Vierge et Enfant', 'Virgin and Child', 'Netherlands', 'Renaissance', '''MNR'' Works At The Musée du Louvre'),
('0017', 'Anonymous', '1900-35', 'Velours à losanges frappés à dominante rouge', 'Velvet with red diamonds', 'Unknown', 'Modern', '''MNR'' Works At The Musée du Louvre'),
('0018', 'Anonymous', '1500-1900', 'Vase hispano-mauresque à quatre anses', 'Hispano-Moorish vase with four handles', 'Spain', 'Renaissance', '''MNR'' Works At The Musée du Louvre'),
